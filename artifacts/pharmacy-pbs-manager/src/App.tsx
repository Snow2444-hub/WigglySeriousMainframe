          ...
          <div className="relative animate-rise-in delay-2">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-sidebar-border bg-sidebar p-5 text-sidebar-foreground shadow-xl sm:p-7">
              ...
              <div className="relative">
                ...
                <div className="mt-5 rounded-2xl border border-sidebar-border bg-sidebar-accent/55 p-4"><div className="flex items-start justify-between"><div><p className="font-mono text-[10px] text-accent">PBS ITEM / 1234K</p><p className="mt-2 text-base font-bold">Crestor 10 mg</p><p className="mt-1 text-xs text-sidebar-foreground/55">Rosuvastatin · AstraZeneca Australia</p></div><span className="rounded-md bg-sidebar-primary px-2 py-1 font-mono text-[10px] font-bold text-sidebar-primary-foreground">F1</span></div><div className="mt-5 grid grid-cols-2 gap-2"><div className="rounded-xl bg-sidebar p-3"><p className="font-mono text-[9px] text-sidebar-foreground/45">AEMP</p><p className="mt-1 font-mono text-sm font-bold">$18.42</p></div><div className="rounded-xl bg-sidebar p-3"><p className="font-mono text-[9px] text-sidebar-foreground/45">DPMQ</p><p className="mt-1 font-mono text-sm font-bold">$22.31</p></div></div></div>
