...
**How to apply:** Ingest the relationship endpoint for every schedule used in a price-history comparison, attach values by `li_item_id`, and compare those authoritative values to produce premium add/change/remove events.